...
function generateThemeIdentifier(identifier, maxlength) {
    var diacriticsMap = [
...
function autoFillThemeIdentifier() {
    var locked = ($('#app_theme_uid').val() != '');
    var maxlength = parseInt($('#app_theme_uid').attr('size'));

    $('#app_theme_name').keyup(function(){
        if(!locked) {
            $('#app_theme_uid').val(generateThemeIdentifier($('#app_theme_name').val(), maxlength));
        }
    });

    $('#app_theme_uid').keyup(function(){
        locked = ($('#app_theme_uid').val() != '' && $('#app_theme_uid').val() != generateThemeIdentifier($('#app_theme_name').val(), maxlength));
    });
}

$(document).ready(function(){
    autoFillThemeIdentifier();
});
